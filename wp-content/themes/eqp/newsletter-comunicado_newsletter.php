    ...
    <tr>
        <td>
            <table style=" border-collapse: collapse;  width: 100%; font-family: sans-serif;" >
                <tr>
                    <td style=" width: 50%; padding-bottom: 20px; border-bottom: 1px dotted #999999; font-family: sans-serif;">
                ...
                <tr>
                    <td style=" width: 99%; padding-top: 20px;">
                        <h1 style="
                            color: #183248;
                            font-size: 28px;
                            font-weight: bold;
                            ...
                            font-family: sans-serif;
                        " >
                            <?php echo $theLayout['encabezado_comunicado_newsletter']; ?>
                        </h1>
                    </td>
                    <td style=" width: 1%; text-align: right;  padding-top: 20px;"></td>
                </tr>
            </table>
            <!-- end content header -->
                ...
                <tr>
                    ...
                    " >
                        <h2 style="
                            ...
                            font-family: sans-serif;
                        " >
                            <?php echo $theLayout['subtitulo_comunicado_newsletter']; ?>
                        </h2>
                        <?php echo $theLayout['contenido_comunicado_newsletter']; ?>
                    </td>
                </tr>
            </table>
        </td>

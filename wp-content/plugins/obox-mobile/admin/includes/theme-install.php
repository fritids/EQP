<?php function mobile_theme_upload(){
	/****************/
	/* File details */
	...
	$plugin_upgrade = new OCMX_Theme_Upgrader( new Theme_Installer_Skin( compact('type', 'title', 'nonce', 'url') ) );
	...
	$themes = get_mobile_themes(OCMXMOBILEDIR."themes");
	$new_theme = get_theme_data(OCMXMOBILEDIR."themes/".$file."/style.css");
    ...
    <div class="new-bubble"><span><?php _e("New"); ?></span></div>

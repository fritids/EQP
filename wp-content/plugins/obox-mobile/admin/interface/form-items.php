<?php function create_mobile_form($input, $counter, $label_class = "") { ?>
	<?php if($label_class != "") : ?>
		...
		switch($input["input_type"]) :
			case 'select';
				...
				<?php elseif($input["options"] == "loop_pages") : ?>
						<option <?php if($input_value == 0){echo "selected=\"selected\"";} ?> value="0"><?php if($input["zero_wording"]) : echo $input["zero_wording"]; else : _e("None"); endif; ?></option>
				<?php endif;
			...
			<?php	break; case 'file': ?>
                ...
                <div class="file">
					...
					<span class="tooltip"><?php _e("Your image".$meta_key." will not be automatically resized."); ?></span>
                </div>
                ...
                <div  class="previous-logos clearfix">
                    ...
                    /*if ($attachments) : ?><h4><?php _e("Previously uploaded ".$input["sub_title"]."'s"); ?></h4><?php endif; */?>                
                    <ul>
                        <?php if ($attachments) :

<?php
function mobile_theme_list(){
	global $ocmx_mobile_class;
	
	if ( current_user_can('switch_themes') && isset($_GET['action']) ) {
		if ( 'activate' == $_GET['action'] ) {
			update_option("ocmx_mobile_theme", $_GET['template']);
			update_option("ocmx_mobile_stylesheet", $_GET['stylesheet']);
		}
	...
	$current_theme = $ocmx_mobile_class->mobile_stylesheet();
	
	$theme_dir = OCMXMOBILEDIR."themes";

	$themes = get_mobile_themes($theme_dir);
	...
	if ( $theme_total ) :
        ...
        <li class="theme-block-item empty clearfix">
        	<a href="#" id="add-theme">
            	<span><?php _e("Add a New Theme"); ?></span>
            </a>
		</li>
	 <?php endif;
}
add_action("mobile_theme_list", "mobile_theme_list");

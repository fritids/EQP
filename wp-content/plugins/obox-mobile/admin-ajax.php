...
add_filter( 'stylesheet', array( &$ocmx_mobile_class, 'mobile_stylesheet'));
add_filter( 'theme_root', array( &$ocmx_mobile_class, 'mobile_template_dir'));
add_filter( 'theme_root_uri', array( &$ocmx_mobile_class, 'mobile_template_uri'));
add_filter( 'template', array( &$ocmx_mobile_class, 'mobile_template'));
